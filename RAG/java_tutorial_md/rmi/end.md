...
You've reached the end of the "RMI" trail.
...
[![](../images/networkingTrail.gif)
Custom Networking](../networking/index.html):
Describes low-level networking capabilities,
such as sockets and datagrams,
provided by the JDK.
...
**Previous page:** Running the Example Programs
