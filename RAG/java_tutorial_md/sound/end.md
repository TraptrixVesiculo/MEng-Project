...
[« Previous](SPI-providing-MIDI.html)
•
[Trail](./TOC.html)

# Sound: End of Trail

You've reached the end of the "Sound" trail.
...
If your program is using sound
and is being used by people all over the world,
the sounds used by your program should be internationalized.
...
**Previous page:** Providing MIDI Services
