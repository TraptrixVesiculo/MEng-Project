...
[« Previous](security/sealing.html)
•
[Trail](./TOC.html)

# The Extension Mechanism: End of Trail

You've reached the end of the "The Extension Mechanism" trail.
...
JAR Files](../deployment/jar/index.html):
Extensions must be bundled in JAR files.
...
**Previous page:** Sealing Packages in Extensions
