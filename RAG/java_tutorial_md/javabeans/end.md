...
[« Previous](beancontext/gui.html)
•
[Trail](./TOC.html)

# JavaBeans(TM): End of Trail

You've reached the end of the "JavaBeans(TM)" trail.
...
[![Trail sign](../images/uiTrail.gif)
Creating a GUI with JFC/Swing](../uiswing/index.html):
Here is where you learn how to produce graphical user interfaces.
This trail includes information on
using the Swing components,
which are JavaBeans-compliant.
...
**Previous page:** AWT Containers and the BeanContextProxy Interface
