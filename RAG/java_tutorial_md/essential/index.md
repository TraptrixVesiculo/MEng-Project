...
[![](../images/coreIcon.gif)
**The Platform Environment**](environment/index.html) is defined by the underlying operating
...
`java.util.regex` API, and presents several working
