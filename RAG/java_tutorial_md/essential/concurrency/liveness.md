...
[« Previous](atomic.html) • [Trail](../TOC.html) • [Next »](deadlock.html)

# Liveness

A concurrent application's ability to execute in a timely manner is
known as its *liveness*. This section describes the most common
kind of liveness problem, [deadlock](deadlock.html), and goes
on to briefly describe two other liveness problems, [starvation and livelock](starvelive.html).

[« Previous](atomic.html)
•
[Trail](../TOC.html)
•
[Next »](deadlock.html)
